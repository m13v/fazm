        ...
        TimelineView(.animation) { timeline in
            ...
            Canvas { context, size in
                ...
                let pulseGradient = Gradient(colors: [
                    FazmColors.purplePrimary.opacity(0.4),
                    FazmColors.purplePrimary.opacity(0.0),
                ])
                ...
                trackPath.addArc(center: center, radius: radius,
                                 ...
                                 clockwise: false)
                context.stroke(trackPath, with: .color(FazmColors.purplePrimary.opacity(0.12)),
                               lineWidth: 3)
                ...
                for i in 0..<particleSpeeds.count {
                    ...
                    let glowGradient = Gradient(colors: [
                        FazmColors.purpleSecondary.opacity(particleOpacities[i] * 0.5),
                        FazmColors.purpleSecondary.opacity(0),
                    ])
